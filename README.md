...
Вы можете задать связку: количетсво комнат и регион, после чего следить за количеством объявлений.
...
Что бы ошибки в асинхронных задачах выбралсывались сразу и что бы корректно выполнить тестирование, 
